...
class PurchasingReportService implements PurchasingReportUseCase
{
    ...
    public function findAll(DTOFilter $filter): ServiceResponse
    {
        ...
        try {
            ...
            $data = $query->get();
            return ServiceResponse::statusOK('successfully get purchasing report', [
                'data' => $data,
                'total' => (int)$total
            ], $meta);
        } catch (\Exception $e) {
    ...
    public function printToPDF(DTOFilter $filter): ServiceResponse
    {
        ...
        try {
            ...
            $pdf = Pdf::loadView('livewire.features.pdf.purchasing-report', [
            ...
            return ServiceResponse::statusOK('successfully export purchasing report to pdf', $pdfBase64);
        } catch (\Exception $e) {
            return ServiceResponse::internalServerError($e->getMessage());
        }
    }
    ...
    public function printToExcel(DTOFilter $filter): ServiceResponse
    {
        ...
        try {
            ...
            return ServiceResponse::statusOK('successfully export purchasing report to excel', [
                'file' => $base64File,
                'file_name' => 'purchasing_report_' . now()->format('Ymd_His') . '.xlsx',
            ]);
        } catch (\Exception $e) {
            return ServiceResponse::internalServerError($e->getMessage());
        }
    ...
    {
        // TODO: Implement makeChart() method.
        try {
