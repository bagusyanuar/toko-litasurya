export function paginate(totalRecords, perPage, currentPage, maxPageRange = 5) {
    ...
    let shownPages = Array.from({length: endPage - startPage + 1}, (_, i) => startPage + i);
    return {totalPages, shownPages};
}
