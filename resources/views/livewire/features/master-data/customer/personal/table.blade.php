<section
    id="section-table-customer-personal"
            ...
            <x-slot name="rows">
                <x-gxui.table.dynamic.row>
                    ...
                    <x-gxui.table.dynamic.td
                        ...
                        class="w-[50px]"
                    >
                        <x-gxui.table.dynamic.action store="customerPersonalTableStore"></x-gxui.table.dynamic.action>
                    </x-gxui.table.dynamic.td>
                </x-gxui.table.dynamic.row>
            </x-slot>
        </x-gxui.table.dynamic.table>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            const componentProps = {
                ...
                onEdit(data) {
                    const id = data['id'];
                    this.actionLoaderStore.start('Finding Customer Process...');
