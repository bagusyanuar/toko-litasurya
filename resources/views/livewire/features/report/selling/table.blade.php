<section
    id="section-selling-table"
    data-component-id="selling-table"
    class="w-full"
>
    <div
        ...
        x-effect="initIcons()"
    >
        <p class="mb-0 text-sm text-neutral-700 font-bold">SELLING LIST</p>
        <div class="flex gap-1 items-center">
            <x-gxui.input.date.datepicker
                id="filterSellingDateStart"
                store="sellingTableStore"
                placeholder="dd/mm/yyyy"
                class="!w-[120px]"
                x-model="$store.sellingTableStore.dateStart"
            ...
            <x-gxui.input.date.datepicker
                ...
                placeholder="dd/mm/yyyy"
                class="!w-[120px]"
                x-model="$store.sellingTableStore.dateEnd"
                x-init="initDatepicker({format: 'dd/mm/yyyy'})"
                dispatcher="onDateChange"
            ></x-gxui.input.date.datepicker>
                ...
                >
                    ...
                    >
                        <div
                            ...
                            x-on:click="open = false; $store.sellingTableStore.onExportPDF()"
                        >
                            <div wire:ignore>
                                <i data-lucide="file"
                        ...
                        <div
                            class="rounded px-3 py-1.5 flex items-center gap-1 cursor-pointer hover:bg-neutral-100 transition-all ease-in duration-200"
                            x-on:click="open = false; $store.sellingTableStore.onExportExcel()"
                        >
                            <div wire:ignore>
    ...
    >
        ...
        <x-slot name="footer">
            ...
            <x-gxui.table.dynamic.th
                ...
                class="w-[120px]"
            >
                <span class="font-extrabold" x-text="$store.sellingTableStore.total.toLocaleString('id-ID')"></span>
            </x-gxui.table.dynamic.th>
        </x-slot>
    </x-gxui.table.dynamic.table>
</section>
...
@push('scripts')
    <script>
        document.addEventListener('alpine:init', () => {
            ...
            const componentProps = {
                ...
                init: function () {
                    Livewire.hook('component.init', ({component}) => {
                        const componentID = document.querySelector('[data-component-id="selling-table"]')?.getAttribute('wire:id');
            ...
            Alpine.store('sellingTableStore', props);
        });
    </script>
@endpush
