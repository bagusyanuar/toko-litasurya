<section
    id="section-selling-return-chart"
    data-component-id="selling-return-chart"
    class="w-full"
>
    <div
        ...
        x-effect="initIcons()"
    >
        <p class="mb-0 text-sm text-neutral-700 font-bold">SELLING RETURN CHART</p>
        <div class="flex gap-1 items-center" wire:ignore>
            <x-gxui.input.date.yearpicker
                id="filterSellingReturnYear"
                store="sellingReturnChartStore"
                placeholder="yyyy"
                class="!w-[120px]"
                x-model="$store.sellingReturnChartStore.year"
    ...
    <div class="w-full relative">
        <div id="selling-return-chart-canvas" class="h-[25rem] w-full" style="min-width: 150px; width: 100%;"></div>
        <div class="w-full absolute z-10 top-0 left-0" x-show="$store.sellingReturnChartStore.loadingSellingChart">
...
@push('scripts')
    <script>
        document.addEventListener('alpine:init', () => {
            ...
            const componentProps = {
                ...
                init: function () {
                    Livewire.hook('component.init', ({component}) => {
                        const componentID = document.querySelector('[data-component-id="selling-return-chart"]')?.getAttribute('wire:id');
                ...
                generateChart(d) {
                    ...
                    let chartEl = document.getElementById('selling-return-chart-canvas');
            ...
            Alpine.store('sellingReturnChartStore', props);
        });
    </script>
@endpush
