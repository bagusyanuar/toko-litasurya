...
>
    <div
        ...
        x-effect="initIcons()"
    >
        <p class="mb-0 text-sm text-neutral-700 font-bold">SELLING RETURN LIST</p>
        <div class="flex gap-1 items-center">
            <x-gxui.input.date.datepicker
                id="filterSellingReturnDateStart"
                store="sellingReturnTableStore"
                placeholder="dd/mm/yyyy"
                class="!w-[120px]"
                x-model="$store.sellingReturnTableStore.dateStart"
                x-init="initDatepicker({format: 'dd/mm/yyyy'})"
                dispatcher="onDateChange"
            ></x-gxui.input.date.datepicker>
            <span class="text-sm text-neutral-700">-</span>
            <x-gxui.input.date.datepicker
                id="filterSellingReturnDateEnd"
                store="sellingReturnTableStore"
                placeholder="dd/mm/yyyy"
                class="!w-[120px]"
                x-model="$store.sellingReturnTableStore.dateEnd"
                x-init="initDatepicker({format: 'dd/mm/yyyy'})"
                dispatcher="onDateChange"
            ></x-gxui.input.date.datepicker>
                ...
                >
                    ...
                    >
                        <div
                            ...
                            x-on:click="open = false; $store.sellingReturnTableStore.onExportPDF()"
                        >
                            <div wire:ignore>
                                <i data-lucide="file"
                        ...
                        <div
                            class="rounded px-3 py-1.5 flex items-center gap-1 cursor-pointer hover:bg-neutral-100 transition-all ease-in duration-200"
                            x-on:click="open = false; $store.sellingReturnTableStore.onExportExcel()"
                        >
                            <div wire:ignore>
