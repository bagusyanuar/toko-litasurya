...
{{--        </div>--}}
        <div class="flex gap-2 items-center text-sm text-neutral-500">
            <span>Showing</span>
            <select
                class="border border-neutral-500 w-fit appearance-none rounded-[4px] text-sm pl-2 !pr-[1.75rem] py-1 outline-none focus:outline-none focus:ring-0 focus:border-neutral-500"
                x-on:change="{{ $onPerPageChange }}"
            >
                <template x-for="value in {{ $pageLength }}">
                    <option :value="value" x-text="value"></option>
