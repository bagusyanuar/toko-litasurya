<div  class="{{ $parentClassName }}">
    ...
    <input
        id="{{ $id }}"
        {{ $attributes->merge(['class' => 'w-full text-xs px-[0.625rem] py-[0.5rem] rounded text-neutral-700 border border-neutral-300 outline-none disabled:bg-neutral-200 focus:outline-none focus:ring-0 focus:border-neutral-500 transition-[border] duration-200 ease-in']) }}
