<div class="w-full h-full flex">
    <div class="w-1.5 h-full bg-green-500 rounded-tl rounded-bl"></div>
    <div class="flex-1 flex p-2 gap-3">
        <div class="w-8" wire:ignore>
            <i data-lucide="circle-check" class="text-green-500 h-8 w-8"></i>
        </div>
        <div class="flex-1 flex flex-col">
            <span class="block font-semibold text-neutral-700 leading-none mb-1">Success</span>
            <span
